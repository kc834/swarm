...
(cl:defmethod cl:initialize-instance :after ((m <StringArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'StringArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controller_executor-msg:<StringArray> is deprecated: use controller_executor-msg:StringArray instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <StringArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller_executor-msg:data-val is deprecated.  Use controller_executor-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<StringArray>)))
  ...
  "controller_executor/StringArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'StringArray)))
  "Returns string type for a message object of type 'StringArray"
  "controller_executor/StringArray")
