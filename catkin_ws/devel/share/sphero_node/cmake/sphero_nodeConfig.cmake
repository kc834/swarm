...
if("TRUE" STREQUAL "TRUE")
  set(sphero_node_SOURCE_PREFIX /home/kchaudhari/catkin_ws/src/sphero-swarm/sphero_ros/sphero_node)
  set(sphero_node_DEVEL_PREFIX /home/kchaudhari/catkin_ws/devel)
  ...
  set(sphero_node_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/kchaudhari/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sphero_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kchaudhari/catkin_ws/src/sphero-swarm/sphero_ros/sphero_node/${idir}'.  Ask the maintainer 'Melonee Wise <melonee@meloneewise.com>' to fix it.")
    endif()
